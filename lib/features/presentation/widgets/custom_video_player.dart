...
class _CustomVideoPlayerState extends State<CustomVideoPlayer> {
  bool get isYoutubeVideo => widget.movieEntity.title!.contains('youtube');

  @override
  void didChangeDependencies() {
    super.didChangeDependencies();
    if (widget.movieEntity.title != null && isYoutubeVideo)
      _loadYoutubeVideo(widget.movieEntity);
  }

  YoutubePlayerController? _youtubeController;

  void _loadYoutubeVideo(MovieEntity spaceMedia) {
    if (_youtubeController == null) {
      final videoId = _filterVideoId("");
          ...
          : !isYoutubeVideo
              ? Column(
                  ...
                  children: [
                    ...
                    TextButton(
                      onPressed: () => _launchURL(widget.movieEntity.title!),
                      child: Text(
                        'Open on browser >',
